...
#define SPML_UCX_DO_CMP(_res, _addr, _op, _val) \
    switch((_op)) { \
        case SHMEM_CMP_EQ: \
            _res = *(_addr) == (_val) ? 1 : 0; \
            break; \
...
#define SPML_UCX_DO_WAIT(_res, _addr, _op, _val) \
    do { \
        unsigned long tmp; \
        SPML_UCX_DO_CMP(_res, _addr, _op, _val);  \
        if (_res == 0) {              \
            ucp_worker_wait_mem(mca_spml_ucx.ucp_worker, (void *)_addr); \
        }                                   \
    } while (_res == 0);
...
int mca_spml_ucx_wait(void* addr, int cmp, void* value, int datatype)
{
    ...
    case SHMEM_INT:
        int_value = *(int*) value;
        int_addr = (int*) addr;
        SPML_UCX_DO_WAIT(res, int_addr, cmp, int_value);
        break;
    ...
    case SHMEM_SHORT:
        ...
        SPML_UCX_DO_WAIT(res, short_addr, cmp, short_value);
        break;
    ...
    case SHMEM_LONG:
        ...
        long_addr = (long*) addr;
        SPML_UCX_DO_WAIT(res, long_addr, cmp, long_value);
        break;
    ...
    case SHMEM_LLONG:
        ...
        SPML_UCX_DO_WAIT(res, longlong_addr, cmp, longlong_value);
        break;
    ...
    case SHMEM_INT32_T:
        ...
        SPML_UCX_DO_WAIT(res, int32_addr, cmp, int32_value);
        break;
    ...
    case SHMEM_INT64_T:
        ...
        SPML_UCX_DO_WAIT(res, int64_addr, cmp, int64_value);
        break;
    ...
    case SHMEM_FINT:
        ...
        SPML_UCX_DO_WAIT(res, fint_addr, cmp, fint_value);
        break;
    ...
    case SHMEM_FINT4:
        ...
        SPML_UCX_DO_WAIT(res, fint4_addr, cmp, fint4_value);
        break;
    ...
    case SHMEM_FINT8:
        ...
        SPML_UCX_DO_WAIT(res, fint8_addr, cmp, fint8_value);
        break;
    }
